...
**Intro Slide 4 — Dawn**
First-person point of view looking out from a seated position on a log at a dying campfire at dawn, the small fire reduced to glowing embers with thin smoke rising straight into windless air, the viewer's knees and rough travelling boots visible at the bottom of frame, a blanket draped over the lap, two or three canvas tents in the middle ground with sleeping settlers, the first golden light of sunrise just touching the treetops beyond the camp while the ground is still in cool blue shadow, dew glistening on the grass, the forest edge glowing warm gold, a single quiet moment before the world wakes, intimate and peaceful, realistic digital painting, dark moody atmosphere, cinematic lighting, no text --ar 16:9
