...
**Intro Slide 4 — Dawn**
Close over-the-shoulder shot from behind a lone figure sitting on a log by a dying campfire at dawn, the figure seen from behind wrapped in a heavy travelling cloak with a hood down, shoulders relaxed and head slightly bowed in quiet thought, the small campfire reduced to glowing embers and thin smoke rising straight into still air, two or three canvas tents in the middle ground with sleeping settlers, the first golden light of sunrise just touching the treetops beyond the camp while the ground is still in cool blue shadow, dew glistening on the grass, the forest edge glowing warm gold, a single quiet moment before the settlement begins, intimate and peaceful, realistic digital painting, dark moody atmosphere, cinematic lighting, no text --ar 16:9
