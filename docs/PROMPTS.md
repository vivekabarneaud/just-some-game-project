...
**Intro Slide 4 — Dawn**
First-person point of view looking down at two weathered hands resting open on the lap, palms up, fingers slightly curled and relaxed, warming in the faint heat of a dying campfire just beyond, the small fire reduced to glowing orange embers with thin smoke rising straight up in the still air, the hands lit by warm ember-glow from one side and cool blue dawn light from the other, a rough wool blanket across the knees barely visible at the edges of frame, out of focus behind the hands two or three canvas tents with sleeping settlers and the first golden light of sunrise touching the treetops, a contemplative downward gaze at one's own hands before the work begins, intimate and quiet, realistic digital painting, dark moody atmosphere, cinematic lighting, no text --ar 16:9
