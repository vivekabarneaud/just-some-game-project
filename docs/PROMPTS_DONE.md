# Midjourney Prompts — The Shattered Realm (COMPLETED)

Archive of prompts whose corresponding image files already exist in `frontend/public/images/`.
Each prompt is followed by the relative path of the generated image.

Split from `PROMPTS.md` — the active TODO file. See PROMPTS.md for prompts still to generate.
...
> ✅ Saved as `missions/scouting_the_surroundings.png`
...
> ✅ Saved as `stories/story_1_slide_1.png`
...
> ✅ Saved as `stories/story_1_slide_2.png`
...
> ✅ Saved as `stories/story_1_slide_3.png`
...
> ✅ Saved as `stories/story_1_slide_4.png`
...
> ✅ Saved as `stories/story_2_slide_1.png`
...
> ✅ Saved as `stories/story_2_slide_2.png`
...
> ✅ Saved as `stories/story_3_slide_1.png`
...
> ✅ Saved as `stories/story_3_slide_2.png`
...
### Novice Missions (Pre-Scouting Village)

All mission scenes: wide shot, 16:9, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text.
...
**The Burning Crypt — Deep** — `burnt_crypt_expedition.png`
Wide shot of a long descending stone stairway in an ancient crypt, carved sarcophagi lining the walls on both sides, black scorch marks streaking up from the floor as if fires had burned from within the tombs, unnatural blue-green flames dancing on top of several lidless sarcophagi without consuming anything, a burnt skeleton wreathed in flame standing at the foot of the stairs with its jaw unhinged, a priest's guttering torch held aloft in the foreground revealing three more skeletal silhouettes in the chamber beyond, smoke drifting upward along the ceiling, the deeper chambers glowing with a sickly orange fire-light, carved warnings in old script on the walls, oppressive heat implied through heat-haze distortion, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/burning_crypt.png`
...
> ✅ Saved as `buildings/tailoring_shop.png`
...
> ✅ Saved as `buildings/leatherworking_town.png`
...
> ✅ Saved as `buildings/marketplace_town.png`
...
> ✅ Saved as `buildings/adventurers_guild_city.png`
...
> ✅ Saved as `buildings/masons_guild_village.png`
...
> ✅ Saved as `buildings/masons_guild_town.png`
...
> ✅ Saved as `buildings/masons_guild_city.png`
...
> ✅ Saved as `items/peppered_jerky.png`
...
> ✅ Saved as `items/smoked_fish.png`
...
> ✅ Saved as `items/grilled_mushrooms.png`
...
> ✅ Saved as `items/cheese_bread.png`
...
> ✅ Saved as `items/saffron_fish_stew.png`
...
> ✅ Saved as `items/groundnut_spice_bowl.png`
...
> ✅ Saved as `items/steamed_dumplings.png`
...
> ✅ Saved as `items/lamb_tagine.png`
...
> ✅ Saved as `items/honeyed_acorn_bread.png`
...
> ✅ Saved as `items/starfruit_meringue.png`
...
> ✅ Saved as `items/forge_roasted_boar.png`
...
> ✅ Saved as `items/harvest_ale_stew.png`
...
> ✅ Saved as `items/hunters_stew.png`
...
> ✅ Saved as `items/spiced_honeycake.png`
...
> ✅ Saved as `items/pea_mint_bowl.png`
...
> ✅ Saved as `items/ashwick_ale_stew.png`
...
> ✅ Saved as `items/blackberry_crumble.png`
...
> ✅ Saved as `items/nordveld_porridge.png`
...
> ✅ Saved as `items/pickled_herring.png`
...
> ✅ Saved as `items/grilled_octopus.png`
...
> ✅ Saved as `items/fig_honey_toast.png`
...
> ✅ Saved as `items/plantain_pepper_fry.png`
...
> ✅ Saved as `items/five_spice_duck.png`
...
> ✅ Saved as `items/jade_tea_soup.png`
...
> ✅ Saved as `items/saffron_rice_pilaf.png`
...
> ✅ Saved as `items/rosewater_pastries.png`
...
> ✅ Saved as `items/elderflower_broth.png`
...
> ✅ Saved as `items/moss_wrapped_trout.png`
...
> ✅ Saved as `items/crystal_consomme.png`
...
> ✅ Saved as `items/deep_mushroom_stew.png`
...
> ✅ Saved as `items/cheese_and_onion_pie.png`
...
> ✅ Saved as `items/apple_butter_toast.png`
...
> ✅ Saved as `items/cherry_cheese_plate.png`
...
> ✅ Saved as `items/smoked_pork_roast.png`
...
> ✅ Saved as `items/fishermans_broth.png`
...
> ✅ Saved as `items/moonpetal_sorbet.png`
...
> ✅ Saved as `items/herbal_antidote.png`
...
> ✅ Saved as `items/strength_draught.png`
...
> ✅ Saved as `items/mending_potion.png`
...
> ✅ Saved as `items/eagle_eye_elixir.png`
...
> ✅ Saved as `items/ironhide_tonic.png`
...
> ✅ Saved as `items/elixir_of_insight.png`
...
> ✅ Saved as `items/netherons_draught.png`


### Novice Missions (Pre-Scouting Village)

**Spider Hollow** — `spider_hollow.png`
Wide shot of an old stone village well at dusk, the wooden bucket and rope pulled up from the dark shaft, thick pale spider silk clinging to the bucket and draped down into the blackness below, a single cave spider the size of a dog crouched on the inner stone rim with multiple gleaming eyes catching the lantern light, more silk strands glinting in the depths below, two village women stepping back in alarm with a dropped water jug shattered on the ground, crude wooden cottages of a frontier settlement visible behind, torchlight warm and low against deep blue twilight, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/spider_hollow.png`

**Cellar Infestation** — `cellar_rats.png`
Wide shot of a dim stone granary cellar lit only by a single hanging oil lantern, tall wooden grain sacks stacked against the walls with visible gnaw holes leaking trickles of wheat onto the flagstones, three enormous rats the size of housecats — matted brown fur, yellow teeth, pink tails — emerging from the shadows with red glinting eyes, a wooden club resting against a barrel in the foreground, claw scratches on the sacks, dust motes drifting in the lantern beam, warm amber lantern light against cold cellar darkness, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/cellar_rats.png`

**The Miller's Boy** — `lost_child.png`
Wide shot of a shallow forest creek at dusk, wooden fish traps half-submerged among the reeds, a child's small leather shoe abandoned at the muddy bank, fresh boar hoofprints pressed into the soft earth around it, a wallowing pit of churned mud just beyond the treeline, a tattered woolen cloak snagged on a branch, the forest darkening to blue-black beyond, a crow watching from a fallen log, a sense of urgency and dread but no child visible, last golden light fading through the trees, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/lost_child.png`

**The Hunter's Keepsake** — `hunter_keepsake.png`
Wide shot of a moss-covered forest clearing along a bear trail, a tarnished brass pocketwatch half-buried in damp leaves and ferns in the foreground, its chain broken and a crack across the glass face, enormous bear claw marks freshly gouged into the bark of a nearby pine, a torn strip of old leather jerkin caught on a thorn branch, the forest thick and close with deep shadows between the trunks, a distant shape moving behind the trees implied rather than seen, dappled grey afternoon light filtering through the canopy, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/hunter_keepsake.png`

**Tracks at the Treeline** — `stranger_tracks.png`
Wide shot from the edge of a lumber worksite looking into the dim forest, enormous deep claw marks gouged into the bark of a pine trunk at the height of a grown man's chest, fresh sap still weeping from the wounds, a matted circular bed of flattened undergrowth visible in the ferns beyond where something large slept, a woodcutter's abandoned axe buried in a log in the foreground, dropped firewood scattered around, drag marks leading away into deeper forest, dappled cold morning light, a sense of recent and unsettling presence, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/stranger_tracks.png`

> **📝 Note on aggressive wildlife (v2 prompts below):** Midjourney biases strongly toward peaceful, photogenic animals — the v1 wolf prompts originally written for these missions produced wolves chilling peacefully by campfires and "pet-like" wolves near adventurers. v2 prompts lean hard on **active-kill language** (mid-lunge, jaws clamped, blood spraying, snarling teeth bared, predator caught mid-attack) and show **visible prey under attack or already dead**. Use the same pattern for any future hostile-wildlife prompts.

**Night Howling v2 — HOSTILE WOLF ATTACK** — `night_howling.png`
Wide shot of a frontier camp under violent wolf attack at midnight, a pack of five feral grey wolves attacking a broken wooden palisade, ONE WOLF MID-LEAP OVER THE FENCE with fangs bared and saliva flying, ANOTHER WOLF ALREADY INSIDE THE CAMP tearing at an overturned sleeping pallet with blood smeared across its muzzle, a third wolf crouched low and snarling with yellow glowing eyes locked on a terrified guard who is stumbling backward with his spear raised, broken weapons and scattered gear in the foreground, an overturned fire pit with embers scattered across the frozen ground, more glowing yellow predator eyes closing in from the dark forest beyond, splattered blood visible on the frost, chaos and terror, cold blue moonlight clashing with orange firelight, violent and grim, NOT peaceful, NOT sleeping, NOT chilling, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/night_howling.png`

**The Old Bridge v2 — COLLAPSED BRIDGE** — `old_bridge.png`
Wide shot of a river crossing where a wooden footbridge has COMPLETELY COLLAPSED INTO THE WATER, only splintered stumps of bridge-posts remain standing on either muddy bank, the rotting broken timbers of the destroyed bridge half-sunken in the brown stream, an ENORMOUS UPROOTED OAK TREE LYING ACROSS THE RUINED FOUNDATION with its massive muddy root ball smashed through what remains of the stone piers, the far bank visible but clearly unreachable without wading or clearing the mess, two aggressive rabid boars charging through the shallow water from the far side with tusks lowered and foam at their mouths, giant rats swarming over the rotting wreckage, NO INTACT BRIDGE anywhere in the frame, NO WAY TO CROSS, the hunting grounds visible as a distant meadow far beyond on the opposite bank, overcast grey afternoon light, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/old_bridge.png`

**Something to Prove v2 — HOSTILE WILD WOLVES AT DISTANCE** — `first_patrol.png`
Wide shot of a lone frontier adventurer cresting a forested ridgeline at dawn, their back to the viewer, wearing weathered leathers and a traveling cloak, driving a wooden boundary marker into the rocky earth with a hammer, surveying untamed wilderness rolling away in layered mist, TWO HOSTILE WILD WOLVES as distant threatening silhouettes FAR ACROSS A DEEP RAVINE on an opposite rocky outcrop, watching the adventurer with predatory intent — clearly feral dangerous enemies, NOT companions, NOT pets, NOT walking beside the adventurer, separated by a wide gulf of dangerous terrain, hackles raised, heads lowered in predator posture, a coil of boundary rope over the adventurer's shoulder, a compass and crude parchment map in the adventurer's hand, the settlement's distant chimney smoke barely visible in the valley far behind, cold pale dawn light breaking through fog, solitary duty in dangerous unclaimed territory, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/first_patrol.png`

**The Wayward Flock v2 — WOLF SLAUGHTER** — `lost_flock.png`
Wide shot of a grassy forest clearing at late afternoon, a scene of sheep slaughter in progress — TWO GREY WOLVES MID-ATTACK on a scattered sheep flock, ONE WOLF WITH ITS JAWS CLAMPED AROUND THE THROAT OF A STRUGGLING SHEEP with blood spraying across the grass, THE OTHER WOLF TEARING AT THE BELLY of a second already-dead sheep on the ground with entrails visible, three surviving sheep bolting in terror with eyes wild and wool torn, bloody tufts of wool caught on low branches, a torn shepherd's dog collar in the foreground with blood on it, heavy blood spatter across the tall grass, golden-hour low sun making the scene more brutal, violent and grim, NOT peaceful, NOT circling, predators mid-kill, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/lost_flock.png`

**Something in the Henhouse v2 — WOLF CAUGHT MID-KILL** — `chicken_coop_raiders.png`
Wide shot of a small wooden chicken coop in a frontier settlement at night, A LARGE GREY WOLF CAUGHT MID-KILL with a freshly killed hen clamped in its BLOODIED FANGED JAWS, standing over three other torn hen carcasses scattered across the dirt yard with feathers and blood everywhere, the wolf's head turned toward the viewer with yellow glowing eyes and teeth bared in a snarl, a second wolf emerging from the shadows behind the coop with lowered head and raised hackles, the coop door torn off its hinges and splintered in the mud, a dropped oil lantern lying on its side still burning and casting warm guttering light on the carnage, a single surviving hen shrieking in terror from the coop's roof, the deep blue-black moonless night pressing in beyond, violent predator caught in the act, NOT peaceful, NOT leaving, mid-feast, realistic digital painting, oil painting style, dark moody atmosphere, cinematic lighting, no text --ar 16:9
> ✅ Saved as `missions/chicken_coop_raiders.png`

### Alchemy — Scholar's Draught
...
> ✅ Saved as `items/scholars_draught.png`
