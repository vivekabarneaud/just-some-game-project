...
> **Restored 2026-09-08.** This doc was deleted on 2026-08-31 by "fold ten
> idea-docs into IDEAS.md", whose message claimed it was "already fully
> duplicated by IDEAS.md ... nothing was lost". That was wrong. IDEAS.md kept a
> five-bullet Alchemy summary; it did not keep the two axes (ROLE = the shelf you
> grab from, TECHNIQUE = the station you place it on), the additive
> effect-vector, the effect palette, the Toxin shelf, the plant sheets, or the
> unified-lab screen layout transcribed from the user's own sketch. A bullet list
> cannot replace a transcribed drawing, so the file is back.
>
> Status lines inside are from 2026-08-02 and are NOT authoritative — check
> DESIGN_INDEX.md and the code before trusting any of them.
