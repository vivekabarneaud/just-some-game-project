...
- **Strawberries** (sweet/treat) — cultivated, distinct from the forager's WILD berries. Plant spring → produce summer. → strawberry jam + a happiness treat / gift. Pairs with Nessa's honey cake (honey + berries).
