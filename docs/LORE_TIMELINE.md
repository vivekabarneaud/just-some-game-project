...
**Casters carry their own power `[LOCKED 2026-06]`.** A trained practitioner does not scoop ambient Aether from the ground mid-cast — their power comes from training, focus, and crystallized Aether (Astral Shards). So **every caster works anywhere**, the thinning and Wastes included; magic is *not* weakened by location. The thinning's danger is the worn boundary (perceptible dead, madness, wrongness), not a magic-dampening field. The schools differ by **method, not by where they are strong**: Arcane (knowledge — works wherever knowledge does), Primal (harmony — *why* they sense and place wards, i.e. the most *attuned* to the thinning, not the weakest in it), Hollow (the only school inherently *tied* to corruption, because it burns dead Aether; not a school adventurers use). Gameplay consequence: no class is mechanically weaker in any zone, and none of this needs to be surfaced to the player.

**Priests are unwitting Primal practitioners `[LOCKED 2026-06]`.** A "priest's blessing" is faith-framed Primal Aether-work: they ease the *perceptible dead* (lay spirits to rest, the soul/boundary half of the thinning) believing they channel the gods, when they are really doing instinctive Primal magic. Consistent with "magic is not divine," the folk-monotheist "Radiant One" heterodoxy (matters later), and Father Corin's quiet study of Edda's rituals. Priests act on the *dead*, not on corrupted *matter*.
...
- **The Ashenmark Dominion** is born from the coup. The Ashford dynasty, the Church of the Radiant One (which becomes *institutional* in this era; the doctrine itself is much older, with roots in the pre-Sundering monotheist heterodoxy and centuries of post-Sundering consolidation), and the Order of the Dawn together.
...
- **The Doctrine of Silence** is formalized. The Church observes correctly that the Wastes expand faster near magical activity. They conclude (incorrectly) that all magic feeds the Wastes. The Inquisition is empowered to suppress magical practice.
...
- **Today.** High King Aldren Ashford, 28. Doesn't know the full truth of how his ancestors took the throne. When he learns, it will shake him.
...
- **Theological problem.** Acknowledging Netheron as essential would unravel the entire monotheistic frame. The Church privately suspects the Doctrine of Silence is incomplete (Archpriest Caelen does), but admitting it would destroy them.
- **The Doctrine of Silence.** Magic use feeds the Wastes. All practice should be suppressed. The conclusion is wrong but the correlation is real.
- **The Inquisition.** Enforces the Doctrine. Hunts Halldora. Burns Old Faith villages. Inquisitor Maren Ashvale uses evidence and persuasion rather than fire — her maps overlaying Wastes expansion with magical activity are genuinely unsettling. Her conclusion is wrong but reasonable.
- **The Order of the Dawn.** Elite military-religious force. Dawn Knights, Paladins, Inquisitors.
...
- **Commander Drayven.** Former Dawn Knight. Defected after watching the Church burn an Old Faith village. Leads the Pale Hand. Knows exactly how the Dominion fights. Suspects the inner ritual is darker than he wants to confront. Hunts the splinter zealots actively. Is the moral question of the Cult walking around in armor.
