...
- **Mechanic (A) — "bring an offering" deploy cost — BUILT 2026-06 (`deployItems`):** a mission costs item/resource amounts to deploy, not just gold; the player must have them, consumed at deploy. Already live on **Greyford** ("The Road to Greyford": bring 40 wheat → 60 stone) — real trade. The witch-offering reuses it directly. (See [[project_mission_mechanics]].)
...
The rabid-boar → Tainted Spring arc is now built as a 5-beat `unique`+`missionDone` chain (see docs/DESIGN_ACT1_SETTING.md for the beat list + gates). It's the worked example of this whole doc's idea: an ordinary problem (sick boars) that escalates into a thinning glimpse, contained not cured. Canon it rests on is locked in `[[project_magic_rules]]` (contain-don't-cleanse, casters carry their own power, priests = unwitting Light/Solara) and the boar tells (mad + water-marked + "the death doesn't take"). **Two follow-ups banked:** (a) **chronicle-firing for regular missions** — beat 4 (`reading_the_carcass`) wants to drop a journal vignette, which needs `chronicleEntryId` added to `MissionTemplate` + completion wiring (currently only StoryMission fires chronicles); (b) a **Father Corin memory/conversation** off beat 4 (we're thin on Corin content). Plus the **Niamh ward** callback (the *proper* containment of the spring, once the Thornveil's unlocked).

## Banked idea — the false cult-alarm (a faith-themed chain, LATER)
Born 2026-06 from "what would put undead near a cemetery? cultists" → the realization that a *scary-cult* beat would be a **mistake**: it cements the Church's propaganda (Cult = evil), the exact thing Rowena tells the Lord to *question*. So flip the goal — not *build fear of the Cult*, but **build distrust of the easy cult-answer** (Rowena's lesson, in miniature, before she says it).
- **The beat:** a panicked gravedigger / Church-fearful villagers cry **"cultists!"** over disturbed graves. You go expecting dark rites and monsters. You find **an old-faith family doing a harmless folk mourning rite** — graveside offerings, the old-god names, *the kind of thing Edda does in her herb-patch* — terrified of being reported (the Inquisition burns villages for less). **No cult. Just grief in an older language, and "cult" was a weapon pointed at frightened people.**
- **Why it's good:** serves the **Doctrine-of-Silence** theme (the Church demonizes the old faith; question what you were taught), ties to **Edda** (her quiet old rites) and **Corin** (the priest fascinated by them), and introduces "cult" as a *blame-word* before the real Cult appears — so Rowena's "it's not what you were told" lands on prepared ground.
- **Cautions:** (1) **Timing** — this is a *faith-theme* beat, and the Church-vs-old-faith tension develops in **Ch3–5+** (faith reconciliation, then the Inquisition). Land it once that theme is live; **not** novice/alpha. (2) **Real Cult content** (actual Hollow ritual, actual undead) stays **story-gated** — don't preempt the Ch4 reveal. (3) No animated undead (see the near-home-hauntings rule in DESIGN_ACT1_SETTING). See `[[project_faith_loyalty_arc]]`.
