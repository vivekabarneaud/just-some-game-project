  ...
  return (
    <div style={{ padding: "16px" }}>
      ...
      >
        ...
        {/* ── The menu ── */}
        <div class="building-card parchment-panel" style={{ "margin-bottom": "16px" }}>
          ...
          {(kind) => {
            ...
            return (
              <div onClick={() => setEditKind(null)} style={{ position: "fixed", inset: "0", background: "rgba(0,0,0,0.6)", display: "flex", "align-items": "center", "justify-content": "center", "z-index": "1000", padding: "16px" }}>
                <div onClick={(e) => e.stopPropagation()} class="building-card parchment-panel" style={{ "max-width": "760px", width: "100%", "max-height": "85vh", display: "flex", "flex-direction": "column" }}>
