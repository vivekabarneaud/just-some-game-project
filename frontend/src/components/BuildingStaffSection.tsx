...
/**
 * Staff manager as an inline SECTION (no modal shell) — folded into the building
 * modal. Coverage model, not optimization: a staffable building runs at full
 * tilt while its named hands (a founder, an adventurer) are home; when the
 * adventurer deploys, output dips toward a floor and the player can bench a
 * townsfolk to hold the post. Kids are flavour only. (Was StaffManageModal.)
 */
