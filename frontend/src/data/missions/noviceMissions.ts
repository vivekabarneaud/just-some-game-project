  ...
  },
{
  ...
  },
  {
    ...
    description: "The northern perimeter hasn't been walked since we arrived. Someone needs to establish a patrol route, mark the boundaries, and make sure nothing's claimed the high ground before we do.",
    icon: "🚩",
    slots: [{ class: "any" }],
    duration: 480,
