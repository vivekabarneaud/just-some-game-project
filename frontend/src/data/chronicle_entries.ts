...
export const CHRONICLE_ENTRIES: ChronicleEntry[] = [
  ...
  },
  {
    ...
    teaser: "A family of hunters walked out of the dark with meat for the pot, and we made room for them at the fire.",
    fullText:
      "We were around the fire with the evening soup when they came out of the trees, a torch bobbing ahead of them in the dark: four of them, three grown and a small boy already talking. Hunters. Before any of us had found our feet, the big one was holding out a brace of fresh-killed game, and the eldest asked, plainly, whether we would mind a few more hands at the pot. They had come offering supper, not begging it. I said yes before she had finished. We are a small handful against a wide forest, and besides, I liked them at once.\n\n" +
      "They are a family. Thornwood. Nessa is the eldest, and it takes about one breath to see she is the one who decides things. She does not raise her voice; she does not need to. Gareth talks enough for all of them and laughs before the joke is done, good company by any fire. Godric is the largest man I have ever stood beside and, so far, the gentlest: it was he who carried the meat, and he gave his own bowl to the children before anyone thought to offer him one.\n\n" +
      "The boy is perhaps seven and the loudest thing that has happened to this camp since we raised the first tent. \"Jack,\" he told me, before the grown three had managed good evening, and a good deal of other business besides. Our Nell watched him the whole while over the rim of her bowl and did not say a word.\n\n" +
      "They ate with us, and their meat stretched the pot to every hand. I have their names set down here, and for now that is enough. The guild has its first hands.",
  },
  {
    id: "ch1_first_scouts",
    chapterId: "ch1",
    ...
    fullText:
      "The scouts are back, on their own feet, with a map and a look I did not like. A wolf pack came at them on the ridge, hungry enough to try armed strangers. They stood, and they made the pack think better of it, and the wolves broke and ran the way hungry things do when the meal fights back. No one was carried home. That is the report I care most about tonight.\n\n" +
      "We read the map by candle, Tomas leaning over it harder than I did. The land is workable. Game trails to the north. Berry thickets along the river. A quarry site on the eastern ridge, and Tomas brightened at that, which is the closest thing to a smile I have seen out of him all week. Water in three places that had not dried by dusk. I have a list now, and a use for every line of it, and a year of work in front of us before there is anything else.\n\n" +
      "But two days' march south, on a hilltop, there is an abandoned watchtower. Stone foundations. A collapsed well. Half the tower still standing. The work of people who had thought ahead. No bodies, no sign of a fight, no graves anyone troubled to dig. They left, or they were made to leave; the scouts could not tell which, and did not care to stay on that hill past midday to find out.\n\n" +
      "And there is one more thing worth the ink. A great stone stands to either side of that hill, each taller than a man and older than the tower by the look of them. Both whole, both cut across every face with marks worn nearly smooth, no letters I know. Old druid-work, I told the team, or a witch's boundary-stone from a year no one remembers; the old country is full of them, set against bad luck and bad neighbors. That is very likely all it is. I wrote it down as that. I noticed that I wanted to.\n\n" +
      "They had stone walls. They had a watchtower. It was not enough. I do not yet know what we know that they did not, or what they knew that we do not. Whatever it was, it is two days south, and we are not ready for two days south. We are barely ready for here. The ruins will keep. The winter will not.\n\n" +
  ...
  },
  {
    ...
    fullText:
      ...
      "Nessa has asked to go and find where they hole up. I have said yes. I do not want a war on the road. I want the road, and I would like it without burying the men standing in the way of it. We will see whether the one giving the orders leaves me the choice.",
  },
  {
    id: "ch1_road_ours",
    chapterId: "ch1",
  ...
  // ── The Stonebridge arrival (late Ch1) — the magic the Lord HARBORS ──
  {
    ...
    fullText:
      ...
      "Father Corin was at the gate before I was, and the two of them fell to talking low and easy the way churchmen do, and when Father Corin caught my eye it was plain he wanted them kept. I did not need much asking. This far out you do not turn away a healer, and a man who has walked this long keeping a silent brother close has earned a roof over both their heads.",
  },
  {
