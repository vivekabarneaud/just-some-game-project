...
export const CHRONICLE_ENTRIES: ChronicleEntry[] = [
  ...
  },
  {
    ...
    fullText:
      ...
      "'There is a ward near the old watch,' she said. 'A stone older than us, set into the land where you would not see it. It holds the edge back from where you live, and from the road between.'\n\n" +
