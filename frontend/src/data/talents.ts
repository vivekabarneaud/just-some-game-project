...
export const WARRIOR_TALENTS: TalentNode[] = [
  ...
  // Row 2: Minor stat branches + first themed talent
  ...
  { id: "w_wis1", name: "Wisdom of Faith", icon: "📖", class: "warrior", row: 4,
    ...
    children: ["w_pal_minor", "w_cap_paladin"] },
  ...
  { id: "w_cap_shadow", name: "Shadowblade Mastery", icon: "🗡️", class: "warrior", row: 6,
...
export const PRIEST_TALENTS: TalentNode[] = [
  ...
  { id: "p_taunt", name: "Righteous Challenge", icon: "📯", class: "priest", row: 3,
    ...
    children: ["p_str2", "p_blessed_armor"] },
...
export const WIZARD_TALENTS: TalentNode[] = [
  ...
  { id: "wz_cap_inquisitor", name: "Divine Judgment", icon: "⚡", class: "wizard", row: 6,
