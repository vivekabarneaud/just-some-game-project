...
export const BUILDINGS: BuildingDefinition[] = [
  ...
  // Camp tier — Adventurer's Guild (missions)
  {
    ...
    maxLevel: 5,
    levels: [
      { level: 1, cost: { wood: 60, stone: 40 }, buildTime: 30, description: "1 mission slot, recruit Novices" },
      { level: 2, cost: { wood: 150, stone: 120 }, buildTime: 180, description: "2 mission slots, recruit up to Apprentice" },
      { level: 3, cost: { wood: 280, stone: 220 }, buildTime: 360, description: "3 mission slots, recruit up to Journeyman" },
      { level: 4, cost: { wood: 500, stone: 400 }, buildTime: 600, description: "4 mission slots, recruit up to Veteran" },
      { level: 5, cost: { wood: 900, stone: 700 }, buildTime: 900, description: "5 mission slots, recruit up to Elite" },
    ],
    requiredTier: "camp",
