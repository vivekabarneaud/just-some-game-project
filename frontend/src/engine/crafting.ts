...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  ...
  // ── Cloaks (light slot, cap uncommon) ──
  { id: "wool_cloak", name: "Wool Cloak", icon: "🧣", building: "tailoring_shop", minLevel: 1,
    costs: [{ resource: "wool", amount: 5 }], produces: { resource: "armor", amount: 1 }, craftTime: 60 },
  { id: "furlined_cloak", name: "Fur-Lined Cloak", icon: "🧥", building: "leatherworking", minLevel: 2,
    costs: [{ resource: "leather", amount: 8 }, { resource: "wolfhide_strip", amount: 2 }], produces: { resource: "armor", amount: 1 }, craftTime: 120 },
  { id: "rangers_cloak", name: "Ranger's Cloak", icon: "🧥", building: "leatherworking", minLevel: 2,
    costs: [{ resource: "leather", amount: 10 }, { resource: "fiber", amount: 3 }], produces: { resource: "armor", amount: 1 }, craftTime: 120 },
  { id: "warded_cloak", name: "Warded Cloak", icon: "🧣", building: "tailoring_shop", minLevel: 2,
    costs: [{ resource: "wool", amount: 5 }, { resource: "fiber", amount: 4 }, { resource: "bone", amount: 1 }], produces: { resource: "armor", amount: 1 }, craftTime: 100 },
  {
    id: "rangers_garb",
    name: "Ranger's Garb",
    icon: "🏹",
  ...
  { id: "marching_boots", name: "Marching Boots", icon: "🥾", building: "leatherworking", minLevel: 2,
    costs: [{ resource: "leather", amount: 10 }], produces: { resource: "armor", amount: 1 }, craftTime: 90 },
  { id: "ironshod_boots", name: "Ironshod Boots", icon: "🥾", building: "leatherworking", minLevel: 2,
  ...
  // ── Cloth shoe uncommons (casters) ──
  { id: "scholar_slippers", name: "Scholar's Slippers", icon: "🥿", building: "tailoring_shop", minLevel: 2,
    costs: [{ resource: "fiber", amount: 6 }, { resource: "wool", amount: 2 }], produces: { resource: "armor", amount: 1 }, craftTime: 90 },
  { id: "pilgrim_sandals", name: "Pilgrim's Sandals", icon: "🥿", building: "tailoring_shop", minLevel: 2,
    costs: [{ resource: "fiber", amount: 6 }, { resource: "leather", amount: 2 }], produces: { resource: "armor", amount: 1 }, craftTime: 90 },
  { id: "acolyte_shoes", name: "Acolyte's Shoes", icon: "🥿", building: "tailoring_shop", minLevel: 2,
    costs: [{ resource: "fiber", amount: 7 }, { resource: "wool", amount: 3 }], produces: { resource: "armor", amount: 1 }, craftTime: 100 },
  { id: "warded_slippers", name: "Warded Slippers", icon: "🥿", building: "tailoring_shop", minLevel: 3,
    costs: [{ resource: "fiber", amount: 6 }, { resource: "wool", amount: 3 }, { resource: "leather", amount: 2 }], produces: { resource: "armor", amount: 1 }, craftTime: 120 },
  ...
  { id: "fishermans_broth", name: "Fisherman's Broth", icon: "🥣", building: "kitchen", minLevel: 7,
    costs: [{ resource: "fish", amount: 3 }, { resource: "turnips", amount: 1 }, { resource: "cabbages", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 60 },
  ...
  { id: "smoked_elk_berries", name: "Smoked Elk & Cloudberries", icon: "🫐", building: "kitchen", minLevel: 3,
    costs: [{ resource: "meat", amount: 3 }, { resource: "berries", amount: 2 }, { resource: "wood", amount: 2 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
  { id: "nordveld_porridge", name: "Nordveld Barley Porridge", icon: "🥣", building: "kitchen", minLevel: 5,
    costs: [{ resource: "barley", amount: 4 }, { resource: "milk", amount: 1 }, { resource: "honey", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 30 },
  { id: "pickled_herring", name: "Pickled Herring", icon: "🐟", building: "kitchen", minLevel: 5,
    costs: [{ resource: "fish", amount: 3 }, { resource: "turnips", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
  ...
  { id: "groundnut_spice_bowl", name: "Groundnut Spice Bowl", icon: "🥜", building: "kitchen", minLevel: 3,
    costs: [{ resource: "nuts", amount: 2 }, { resource: "peas", amount: 2 }, { resource: "squash", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
  { id: "jollof_rice", name: "Zah'kari Jollof", icon: "🍚", building: "kitchen", minLevel: 5,
    costs: [{ resource: "grain", amount: 4 }, { resource: "meat", amount: 2 }, { resource: "squash", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 60 },
  { id: "plantain_pepper_fry", name: "Plantain Pepper Fry", icon: "🍌", building: "kitchen", minLevel: 5,
    costs: [{ resource: "squash", amount: 3 }, { resource: "peas", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },

  // Tianzhou — delicate, precise, balanced
  { id: "steamed_dumplings", name: "Steamed Dumplings", icon: "🥟", building: "kitchen", minLevel: 3,
    costs: [{ resource: "grain", amount: 3 }, { resource: "meat", amount: 1 }, { resource: "cabbages", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
  { id: "five_spice_duck", name: "Five-Spice Duck", icon: "🦆", building: "kitchen", minLevel: 5,
    costs: [{ resource: "meat", amount: 5 }, { resource: "honey", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 90 },
  { id: "jade_tea_soup", name: "Jade Tea Soup", icon: "🍵", building: "kitchen", minLevel: 5,
    costs: [{ resource: "peas", amount: 2 }, { resource: "cabbages", amount: 2 }, { resource: "mushrooms", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
  ...
  { id: "forge_roasted_boar", name: "Forge-Roasted Boar", icon: "🐗", building: "kitchen", minLevel: 3,
    costs: [{ resource: "meat", amount: 6 }, { resource: "turnips", amount: 2 }, { resource: "wood", amount: 3 }], produces: { resource: "food", amount: 1 }, craftTime: 60 },
  { id: "deep_mushroom_stew", name: "Deep Mushroom Stew", icon: "🍄", building: "kitchen", minLevel: 5,
    costs: [{ resource: "mushrooms", amount: 4 }, { resource: "milk", amount: 1 }, { resource: "grain", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 60 },
  { id: "iron_bread", name: "Iron Bread", icon: "🍞", building: "kitchen", minLevel: 5,
    costs: [{ resource: "grain", amount: 3 }, { resource: "iron", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },

  // Feldgrund — cozy, abundant, pub food
  { id: "harvest_ale_stew", name: "Harvest Ale Stew", icon: "🍺", building: "kitchen", minLevel: 3,
    costs: [{ resource: "meat", amount: 3 }, { resource: "cabbages", amount: 2 }, { resource: "grain", amount: 2 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
  { id: "cheese_and_onion_pie", name: "Cheese & Onion Pie", icon: "🥧", building: "kitchen", minLevel: 5,
    costs: [{ resource: "milk", amount: 2 }, { resource: "turnips", amount: 2 }, { resource: "grain", amount: 2 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
  { id: "apple_butter_toast", name: "Apple Butter Toast", icon: "🍎", building: "kitchen", minLevel: 5,
    costs: [{ resource: "apples", amount: 3 }, { resource: "grain", amount: 2 }, { resource: "honey", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 45 },
];
