...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  ...
  // Tankard of Ale — the tavern pours the brewery's ale (needs a brewery to
  // have any ale in stock). Cook-to-order consumes `ale` from the barrel.
  { id: "poured_ale", name: "Tankard of Ale", icon: "🍺", building: "kitchen", minLevel: 1, kind: "drink",
    costs: [{ resource: "ale", amount: 2 }], produces: { resource: "food", amount: 4 }, craftTime: 5 },
