...
export const CRAFTING_RECIPES: CraftingRecipe[] = [
  ...
  { id: "peppered_jerky", name: "Peppered Jerky", icon: "🌶️", building: "kitchen", minLevel: 1,
    costs: [{ resource: "meat", amount: 4 }], produces: { resource: "food", amount: 1 }, craftTime: 30,
    requiredTool: "cutting_board" },
  { id: "herb_salad", name: "Fresh Herb Salad", icon: "🥬", building: "kitchen", minLevel: 1,
    costs: [{ resource: "cabbages", amount: 2 }, { resource: "mushrooms", amount: 1 }], produces: { resource: "food", amount: 1 }, craftTime: 20,
    requiredTool: "cutting_board" },
  { id: "smoked_fish", name: "Smoked Fish", icon: "🐟", building: "kitchen", minLevel: 1,
    costs: [{ resource: "fish", amount: 3 }, { resource: "wood", amount: 2 }], produces: { resource: "food", amount: 1 }, craftTime: 30 },
  { id: "grilled_mushrooms", name: "Grilled Mushrooms", icon: "🍄", building: "kitchen", minLevel: 1,
    costs: [{ resource: "mushrooms", amount: 3 }], produces: { resource: "food", amount: 1 }, craftTime: 30 },
