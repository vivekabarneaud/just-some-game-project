  ...
  },
{
    ...
    description: "Guard a traveling merchant along the trade road for a share of their profits. The bandits hit in pairs — so should you.",
    icon: "💰",
  ...
  },
{
    ...
    duration: 900,
    rewards: [{ resource: "gold", amount: 50 }, { resource: "wheat", amount: 30 }],
    deployCost: 10,
    difficulty: 1,
    minGuildLevel: 1,
    tags: ["escort", "combat"],
