  ...
  },
{
  ...
  // ── Pre-scouting village missions (no story gate) ─────────────
  {
    ...
    slots: [{ class: "any" }, { class: "any" }],
    duration: 360,
    rewards: [{ resource: "food", amount: 40 }, { resource: "gold", amount: 15 }],
    deployCost: 3,
    difficulty: 1,
    minGuildLevel: 1,
    tags: ["combat"],
  ...
  },
  {
    ...
    slots: [{ class: "any" }],
    duration: 600,
    rewards: [{ resource: "gold", amount: 20 }, { resource: "food", amount: 30 }],
    deployCost: 3,
    difficulty: 1,
    minGuildLevel: 1,
    tags: ["outdoor", "exploration"],
  ...
  },
  {
    ...
    slots: [{ class: "any" }, { class: "any" }],
    duration: 540,
    rewards: [{ resource: "food", amount: 60 }, { resource: "gold", amount: 15 }],
    deployCost: 3,
    difficulty: 1,
    minGuildLevel: 1,
    tags: ["combat", "outdoor"],
  ...
  },
  {
    ...
    slots: [{ class: "any" }],
    duration: 480,
    rewards: [{ resource: "gold", amount: 20 }, { resource: "food", amount: 20 }],
    deployCost: 3,
    difficulty: 1,
    minGuildLevel: 1,
    tags: ["outdoor", "combat"],
  ...
  // ── Pre-scouting missions gated behind livestock pens ─────────
  {
    ...
    slots: [{ class: "any" }],
    duration: 420,
    rewards: [{ resource: "food", amount: 60 }, { resource: "gold", amount: 10 }],
    deployCost: 3,
    difficulty: 1,
    minGuildLevel: 1,
    tags: ["outdoor"],
  ...
  },
  {
    ...
    slots: [{ class: "any" }, { class: "any" }],
    duration: 540,
    rewards: [{ resource: "food", amount: 50 }, { resource: "gold", amount: 10 }],
    deployCost: 3,
    difficulty: 1,
    minGuildLevel: 1,
    tags: ["combat", "outdoor"],
