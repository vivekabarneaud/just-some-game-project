  ...
  },
{
    ...
    description: "A spring in the forest has begun to glow, faint and wrong, and the water tastes of metal. The deer that used to drink there are gone, and a boar that did came back foaming and had to be put down. Send a wizard to read what has gotten into the water before the whole tree line drinks from it.",
    icon: "💧",
  ...
  },
{
    ...
    requires: { missionDone: "bad_season_boars" },
    unique: true,
  },
{
    id: "marsh_clearing",
