  ...
  },
{
    ...
    duration: 1200,
    rewards: [{ resource: "fish", amount: 100 }, { resource: "meat", amount: 30 }, { resource: "gold", amount: 20 }],
    deployCost: 10,
    difficulty: 2,
    minGuildLevel: 2,
    tags: ["outdoor"],
  ...
  },
{
    ...
    duration: 1800,
    rewards: [{ resource: "meat", amount: 80 }, { resource: "wolfhide_strip", amount: 1 }, { resource: "fang", amount: 1 }, { resource: "gold", amount: 50 }],
    deployCost: 20,
    difficulty: 2,
    minGuildLevel: 2,
  ...
  },
{
    ...
    description: "The old settlement graveyard has grown noisy at night. The boundary is thinning, and spirits wander freely. Bring someone who can actually hit them.",
    icon: "👻",
  ...
  },
{
    id: "wyrmling_den",
    name: "Wyrmling Den",
    description: "Farmers found scorched chicken coops and tiny claw marks. Something hatched in the hills nearby, small and scared and breathing fire. Handle it before it grows.",
    icon: "🦎",
    image: "https://pub-63efdde7a8414a0393a736c5add726cc.r2.dev/images/missions/wyrmling_den.png",
    slots: [{ class: "any" }, { class: "any" }],
    duration: 1500,
    rewards: [{ resource: "gold", amount: 80 }, { resource: "eggs", amount: 30 }],
    deployCost: 15,
    difficulty: 2,
    minGuildLevel: 2,
    tags: ["combat", "outdoor"],
  ...
  },
{
    ...
    description: "A Tianzhou cartographer is mapping the Wastes border and needs protection. She pays well and shares what she finds. The border is dangerous, and the dead don't respect academic curiosity.",
    icon: "🗺️",
  ...
  },
{
    ...
    slots: [{ class: "any" }, { class: "any" }, { class: "any" }],
    duration: 2400,
    rewards: [{ resource: "meat", amount: 60 }, { resource: "thick_pelt", amount: 1 }, { resource: "bear_claw", amount: 2 }, { resource: "gold", amount: 100 }],
    deployCost: 25,
    difficulty: 3,
    minGuildLevel: 2,
    tags: ["combat", "outdoor"],
