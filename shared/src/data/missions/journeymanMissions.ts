  ...
  },
{
    ...
    duration: 2700,
    rewards: [{ resource: "gold", amount: 200 }, { resource: "meat", amount: 50 }, { resource: "wolfhide_strip", amount: 1 }, { resource: "fang", amount: 1 }],
    deployCost: 40,
    difficulty: 3,
    minGuildLevel: 3,
    tags: ["combat", "outdoor"],
  ...
  },
{
    ...
    duration: 2400,
    rewards: [{ resource: "gold", amount: 180 }, { resource: "cinnamon", amount: 3 }],
    deployCost: 35,
    difficulty: 3,
    minGuildLevel: 3,
    tags: ["escort", "magical"],
  ...
  },
{
    ...
    slots: [{ class: "warrior" }, { class: "archer" }, { class: "priest" }],
    duration: 3000,
    rewards: [{ resource: "gold", amount: 250 }, { resource: "meat", amount: 60 }, { resource: "astralShards", amount: 2 }],
    deployCost: 50,
    difficulty: 3,
    minGuildLevel: 3,
