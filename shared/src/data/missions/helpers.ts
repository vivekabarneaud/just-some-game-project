...
const FOOD_ITEM_LABELS: Record<string, { icon: string; name: string }> = {
  ...
  nuts: { icon: "🌰", name: "Nuts" },
  // Meat cuts (post meat-split) — labels/icons mirror frontend FOOD_ITEMS.
  venison: { icon: "🦌", name: "Venison" },
  boar: { icon: "🐗", name: "Boar" },
  wisent: { icon: "🦬", name: "Wisent" },
  pork: { icon: "🥓", name: "Pork" },
  mutton: { icon: "🐑", name: "Mutton" },
  goat: { icon: "🐐", name: "Goat" },
  chicken: { icon: "🍗", name: "Chicken" },
  wild_fowl: { icon: "🦆", name: "Wild Fowl" },
  rabbit: { icon: "🐰", name: "Rabbit" },
  // Fish (post fish-split)
  trout: { icon: "🐟", name: "Trout" },
  pike: { icon: "🐠", name: "Pike" },
  eel: { icon: "🐍", name: "Eel" },
  salmon: { icon: "🍥", name: "Salmon" },
  // Wild foods
  blackberry: { icon: "🫐", name: "Blackberry" },
  blueberry: { icon: "🫐", name: "Blueberry" },
  raspberry: { icon: "🫐", name: "Raspberry" },
  dandelion: { icon: "🌼", name: "Dandelion" },
  sorrel: { icon: "🌿", name: "Sorrel" },
  ramsons: { icon: "🧄", name: "Ramsons" },
  wild_carrot: { icon: "🥕", name: "Wild Carrot" },
  field_mushroom: { icon: "🍄", name: "Field Mushroom" },
