...
export const ARMOR: ItemDefinition[] = [
  ...
  {
    id: "greypelt_jerkin", rarity: "uncommon", name: "Greypelt Jerkin", icon: "🐺", slot: "chest",
    description: "+1 DEX, +2 Dodge, 26 DEF",
    flavor: "A jerkin cut from grey pelts and laced with sinew. Light enough to twist away from a blow, warm enough for a cold watch.",
    classes: [], armorType: "leather",
    stats: { dex: 1 }, raw: { dodge: 2 }, durationMod: 1, lootMod: 1,
    recipeId: "greypelt_jerkin", consumable: false, defense: 26,
  },
  {
    id: "wolfhide_treads", rarity: "uncommon", name: "Wolfhide Treads", icon: "🥾", slot: "boots",
    description: "+1 DEX, +2 Mobility, 12 DEF",
    flavor: "Soft-soled and sinew-stitched. You cross broken ground the way the pack does — quick, quiet, already there.",
    classes: [], armorType: "leather",
    stats: { dex: 1 }, raw: { mobility: 2 }, durationMod: 1, lootMod: 1,
    recipeId: "wolfhide_treads", consumable: false, defense: 12,
  },
  {
    id: "hunters_cloak", rarity: "uncommon", name: "Hunter's Cloak", icon: "🧣", slot: "cloak",
    description: "+1 DEX, -5 Presence, 10 DEF",
    flavor: "A cloak of grey wolf-fur, hood and all. In the treeline you're just another shadow the pack throws.",
    classes: [], armorType: "leather",
    stats: { dex: 1 }, raw: { presence: -5 }, durationMod: 1, lootMod: 1,
    recipeId: "hunters_cloak", consumable: false, defense: 10,
  },
  {
    id: "fang_gauntlets", rarity: "uncommon", name: "Fang-Studded Gauntlets", icon: "🧤", slot: "gloves",
    description: "+1 DEX, +3 Crit, 10 DEF",
    flavor: "Leather gloves set with wolf-fangs across the knuckles. Every strike finds the soft place.",
    classes: [], armorType: "leather",
    stats: { dex: 1 }, raw: { crit: 3 }, durationMod: 1, lootMod: 1,
    recipeId: "fang_gauntlets", consumable: false, defense: 10,
  },

  // ── Boar tank set (toughness) — +Presence on the two signature pieces ──
  {
    id: "bristlehide_hauberk", rarity: "uncommon", name: "Bristlehide Hauberk", icon: "🐗", slot: "chest",
    description: "+1 STR, +5 Presence, 38 DEF",
    flavor: "Coarse boarhide, bristles and all, over a thick felt of padding. It doesn't help you dodge — it just doesn't care that you got hit.",
    classes: [], armorType: "leather",
    stats: { str: 1 }, raw: { presence: 5 }, durationMod: 1, lootMod: 1,
    recipeId: "bristlehide_hauberk", consumable: false, defense: 38,
  },
  {
    id: "bristlehide_greaves", rarity: "uncommon", name: "Bristlehide Greaves", icon: "👖", slot: "legs",
    description: "+1 STR, 24 DEF",
    flavor: "Thick boarhide over the thighs. Won't win you any footraces, but it hits back a little harder and takes a knock without complaint.",
    classes: [], armorType: "leather",
    stats: { str: 1 }, durationMod: 1, lootMod: 1,
    recipeId: "bristlehide_greaves", consumable: false, defense: 24,
  },
  {
    id: "tusked_boar_hood", rarity: "uncommon", name: "Tusked Boar-Hood", icon: "🪖", slot: "head",
    description: "+1 VIT, +5 Presence, 18 DEF",
    flavor: "A hood of boarhide crowned with the beast's own bristles, its tusks jutting at your brow. You don't so much wear it as become the thing that comes out of the treeline.",
    classes: [], armorType: "leather",
    stats: { vit: 1 }, raw: { presence: 5 }, durationMod: 1, lootMod: 1,
    recipeId: "tusked_boar_hood", consumable: false, defense: 18,
  },
  {
    id: "bristlehide_shoes", rarity: "uncommon", name: "Bristlehide Shoes", icon: "🥾", slot: "boots",
    description: "+1 VIT, 13 DEF",
    flavor: "Sturdy boarhide shoes. You won't outrun anyone — but you don't get shoved around, either. Planted.",
    classes: [], armorType: "leather",
    stats: { vit: 1 }, durationMod: 1, lootMod: 1,
    recipeId: "bristlehide_shoes", consumable: false, defense: 13,
  },
  {
