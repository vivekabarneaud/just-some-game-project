...
export const ALCHEMY_RECIPES: AlchemyRecipeDefinition[] = [
  ...
  // ── Novice (discoverable) ─────────────────────────────────────
  {
    ...
    icon: "🧪",
    description: "Cures poison. In combat: drunk the moment poison lands, curing it and healing 20% HP. At home: clears poison from a resting hero. On a mission: +5 stat check, -15% death risk.",
    tier: "novice",
    minLabLevel: 1,
    costs: [{ resource: "nettle", amount: 2 }],
    effect: "curePoison,successBonus:5,deathReduction:0.85",
    craftTime: 420,
    discoveryChance: 0.4,
  },
