...
export const ALCHEMY_RECIPES: AlchemyRecipeDefinition[] = [
  // ── Novice (Lab lvl 1-2, starter recipes) ─────────────────────
  {
    ...
    name: "Healing Salve",
    icon: "💚",
    description: "At home or before a fight: heals 25% HP. In combat: auto-heals 30% HP when low. On a mission: -25% death chance.",
    tier: "novice",
    minLabLevel: 1,
    costs: [{ resource: "chamomile", amount: 3 }],
    effect: "healPct:25,deathReduction:0.75",
    craftTime: 300,
    starterRecipe: true,
    discoveryChance: 0,
  },
  ...
  // ── Novice (discoverable) ─────────────────────────────────────
  {
    ...
    icon: "🧪",
    description: "Non-combat: +5 stat check, -15% death risk. Combat: auto-heal 20% HP when low.",
    tier: "novice",
    minLabLevel: 1,
