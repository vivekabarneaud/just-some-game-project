...
export const FORAGE_PLANTS: ForagePlant[] = [
  ...
  { id: "ramsons", name: "Ramsons", icon: "🧄", yields: "ramsons", artVariants: 1,
    note: "Wild garlic from the spring woods, a burst of white stars on a bare stalk, and the smell of it on your hands all afternoon. It lifts whatever it touches.",
    clump: 6,
    size: [0.8, 1.2], grows: ["litter", "wood"],
  ...
  { id: "lily_of_the_valley", name: "Lily of the Valley", icon: "🌱", yields: null, mimics: "ramsons", artVariants: 1,
    note: "Lily of the valley, which would have stopped a heart. Look at the flowers: ramsons carry a burst of little white stars on a bare stalk, these a row of white bells all nodding the same way. And crush a leaf — ramsons reeks of garlic, this of nothing at all.",
    clump: 5,
    size: [0.8, 1.2], grows: ["litter", "wood"],
