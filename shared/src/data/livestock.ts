...
export const ANIMALS: AnimalDefinition[] = [
  ...
  },
  {
    ...
    name: "Pigs",
    icon: "🐷",
    description: "Hungry, and kept for meat — a pig pays off when it's culled, not while it lives. Needs plenty of grain.",
    foodConsumedPerHour: 3,
    foodProducedPerHour: 0, // no living byproduct — the pig IS the cull (meat + leather + bone)
    foodLabel: "Meat",
  ...
  },
  {
    ...
    name: "Sheep",
    icon: "🐑",
    description: "Give wool (spring to autumn) and a little milk while they live; a culled sheep also yields meat. Essential for surviving winter.",
    foodConsumedPerHour: 2,
