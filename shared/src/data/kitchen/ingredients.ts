...
export const FOOD_INGREDIENTS: FoodIngredient[] = [
  ...
  { id: "meat", name: "Meat", icon: "🍖", role: "protein", signature: "roast", nourish: 5, comfort: 3, note: "Good red meat from pen or hunt." },
  { id: "fish", name: "Fish", icon: "🐟", role: "protein", signature: "fry", nourish: 3, comfort: 2, fresh: 1, note: "From the river, light and quick." },
  ...
  { id: "bone", name: "Bone", icon: "🦴", role: "protein", signature: "boil", nourish: 3, comfort: 1, note: "Marrow for a long, rich broth." },

  // ── Veg (body; peas + fava are the early legumes) ──
  { id: "cabbages", name: "Cabbage", icon: "🥬", role: "veg", signature: "chop", nourish: 2, comfort: 1, fresh: 2, note: "Hardy leaf, good raw or cooked." },
  { id: "turnips", name: "Turnips", icon: "🥕", role: "veg", signature: "boil", nourish: 3, comfort: 1, note: "Earthy root, keeps the pot honest." },
  { id: "squash", name: "Gourd", icon: "🎃", role: "veg", signature: "roast", nourish: 3, comfort: 2, note: "Sweetens as it cooks down." },
  { id: "peas", name: "Peas", icon: "🫛", role: "veg", signature: "boil", nourish: 3, comfort: 1, note: "Legume — pease porridge hot or cold." },
  { id: "fava", name: "Fava Beans", icon: "🫘", role: "veg", signature: "boil", nourish: 3, comfort: 1, note: "Broad beans — early protein before the herd." },
  { id: "mushrooms", name: "Mushrooms", icon: "🍄", role: "veg", signature: "fry", nourish: 2, comfort: 2, note: "Foraged, savoury depth." },

  // ── Fruit (sweet) ──
  { id: "apples", name: "Apples", icon: "🍎", role: "fruit", signature: "chop", nourish: 1, comfort: 3, fresh: 3, note: "Crisp and cheering." },
  { id: "pears", name: "Pears", icon: "🍐", role: "fruit", signature: "chop", nourish: 1, comfort: 3, fresh: 2, note: "Soft, honeyed." },
  { id: "cherries", name: "Cherries", icon: "🍒", role: "fruit", signature: "chop", nourish: 1, comfort: 4, fresh: 2, note: "Bright and tart, a summer joy." },
  { id: "strawberries", name: "Strawberries", icon: "🍓", role: "fruit", signature: "chop", nourish: 1, comfort: 4, fresh: 3, note: "Fleeting early-summer sweetness." },
  ...
  { id: "honey", name: "Honey", icon: "🍯", role: "spice", signature: "boil", amplify: 0.2, comfort: 1, note: "Sweetens and rounds it out." },
  { id: "lavender", name: "Lavender", icon: "💜", role: "spice", signature: "chop", amplify: 0.15, fresh: 1, note: "Fragrant blooms — teas and honey-cakes." },
  ...
  { id: "long_pepper", name: "Long Pepper", icon: "🌶️", role: "spice", signature: "boil", amplify: 0.2, note: "A warming bite that lifts a dish (a trade spice)." },
];
