...
export const ENEMIES: EnemyDefinition[] = [
  ...
  },
  {
    ...
    name: "Spooked Boar",
    icon: "🐗",
    description: "A young boar — more afraid than angry. Not rabid, not yet. Still has tusks, though.",
    tier: 1,
  ...
  },
  {
    ...
    name: "Goblin Runt",
    icon: "👺",
    description: "The smallest of the goblin scouts — usually the one sent ahead to trip the traps. Easy prey, if you can catch it.",
    tier: 1,
